...
@echo        ^</appSettings^>
@echo  6) Script creates following symbolic links:
...
@echo  8) Script checks if on this directory contains file web.sitemap
...
@echo      - "content" pointing to "\\flsrv\share\unimainz_content"
